    ...
    getUserDetails() {
        ...
        this.appService.getUserInfo(id).subscribe(
            data => {
                ...
                this.snackBar.open(`some error occured please check number`, "Dismiss", {
                    duration: 5000,
                });
    ...
    getUsersFriends() {
        ...
        this.appService.getUserFriends(this.userInfo.friends).subscribe(
            data => {
                ...
                this.snackBar.open(`some internal error occured`, "Caution", {
                    duration: 5000,
                });
        ...
        this.appService.unFriend(this.userInfo.userId, this.id).subscribe(
            data => {
                ...
                if (data['status'] === 200) {
                    ...
                    this.snackBar.open(`Friend has been removed succesfully`, "Dismiss", {
                        duration: 5000,
                    });
                    ...
                    this.snackBar.open(`Some error occured in removing your friend please try again or write to us if issue persists`, "Dismiss", {
                        duration: 5000,
                    });
