...
let signUpMail = (email, fullName) => {
        ...
        let mailOptions = {
            ...
            <body style="margin:0">
                <div>
                    <div class="container">
                        <h1 class="header">Task Reminder</h1>
                        <br>
                        <br>
                        <br>
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="card card-1">
                            ...
                            <br>
                            <p class="text-center">${name} has invited you to check out <a href="http://www.virtuasha.online/sign-up?userId=${userId}">Task Reminder</a> app.</p>
                        </div>
                    </div>
                </div>
                <br>
