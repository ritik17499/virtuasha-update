...
let deleteUser = (req, res) => {
    ...
    });// end user model find and remove function
...
let editUser = (req, res) => {
    ...
    });// end user model update function
}// end edit user
// Pushing the user  to request Array function
let request = (req, res) => {
...
let addFriend = (req, res) => {
    ...
    // adding user to his friend's  "friends" array (updating)
